...
public class RecommendedRecyclerAdapter extends RecyclerView.Adapter<RecommendedRecyclerAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Glide.with(context)
                .load(productsCategoryData.get(position).getOriginal_image())
                .placeholder(R.drawable.no_image_available)
                .into(holder.ivRecommended);
        if (productsCategoryData.get(position).getOriginal_image().equals("")) {
    ...
    public final class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            String catId = productsCategoryData.get(this.getLayoutPosition()).getCategory_id();
