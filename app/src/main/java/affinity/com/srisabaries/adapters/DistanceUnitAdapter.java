 ...
 */
public class DistanceUnitAdapter extends ArrayAdapter<String> {
    //list of client data
    ...
    public DistanceUnitAdapter(Activity activity, int textViewResourceId, List<String> distanceUnitList, int checkedPos) {
