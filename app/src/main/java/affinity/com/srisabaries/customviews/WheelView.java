...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private CustomTypefaceTextView createView(String item) {
        CustomTypefaceTextView tv = new CustomTypefaceTextView(context);
        tv.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        tv.setSingleLine(true);
        tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, getContext().getResources().getDimension(R.dimen.s_tv_profile_txt));
        tv.setText(item);
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(ContextCompat.getColor(getContext(), R.color.c_bg_toolbar_settings));
            } else {
                itemView.setTextColor(ContextCompat.getColor(getContext(), R.color.c_tv_profile_txt));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(ContextCompat.getColor(getContext(), R.color.c_bg_toolbar_settings));
