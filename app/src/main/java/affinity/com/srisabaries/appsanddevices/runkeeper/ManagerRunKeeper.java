package affinity.com.srisabaries.appsanddevices.runkeeper;
...
import affinity.com.srisabaries.CartApplication;
    ...
    public void getAuthorizationCode(final Activity activity, final ConnectAppsAndDevicesFragment ConnectAppsDevicesFragment) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(CartApplication.getGlobalContext());
