...
import affinity.com.srisabaries.ui.fragments.TutorialFragment;
...
public class TutorialActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private List<Fragment> getTutorialFragments() {
        ...
        mTutorialFragmentList.add(TutorialFragment.newInstance(R.drawable.tutorial_screen1, R.string.txt_tutorial_first, R.string.txt_title_tutorial_first));
        mTutorialFragmentList.add(TutorialFragment.newInstance(R.drawable.tutorial_screen2, R.string.txt_tutorial_second, R.string.txt_title_tutorial_second));
        mTutorialFragmentList.add(TutorialFragment.newInstance(R.drawable.tutorial_screen3, R.string.txt_tutorial_third, R.string.txt_title_tutorial_third));
