 ...
 */
public class AppTutorialFragment extends BaseFragment {
    ...
    public static final AppTutorialFragment newInstance(int imageResourceId, int textResourceId, int titleResourceId) {
        AppTutorialFragment tutorialFragment = new AppTutorialFragment();
