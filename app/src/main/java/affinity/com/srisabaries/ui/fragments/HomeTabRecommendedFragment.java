...
public class HomeTabRecommendedFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void getProductsListForHomeTabs() {
        ...
        Call<ResGetProductsList> resGetProductsListCall = client.getProductsList(mAppSharedPreference.getString(PreferenceKeys.KEY_SERVICE_KEY, ""),"127");
    ...
    private void openDetailScreen(int pos) {
        ...
        intent.putExtra("productId", productsListData.get(pos).getProduct_id().toString());
